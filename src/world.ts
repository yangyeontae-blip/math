...
export class World {
  ...
  private swingUntil = 0; private rideIndex = -1; private petIndex = -1; private petModel: T.Group | null = null; private rideAnimated: T.Object3D[] = []; private butterflies: T.Object3D[] = [];
